...
- (void)style {
	self.selectedFont = [UIFont boldFlatFontOfSize:18.0];
	self.selectedFontColor = [UIColor whiteColor];
	self.selectedColor = [UIColor skyBlueColor];
	
	self.deselectedFont = [UIFont flatFontOfSize:16.0];
	self.deselectedFontColor = [UIColor skyBlueColor];
	self.deselectedColor = [UIColor whiteColor];
	
	self.dividerColor = [UIColor tinColor];
	self.cornerRadius = 5.0;
}
