...
+ (void)styleAlertView:(FUIAlertView *)alertView {
	alertView.titleLabel.textColor = [UIColor skyBlueColor];
	...
	alertView.backgroundOverlay.backgroundColor = [[UIColor softMetalColor] colorWithAlphaComponent:0.5];
	alertView.alertContainer.backgroundColor = [UIColor wetAsphaltColor];
	alertView.defaultButtonColor = [UIColor softMetalColor];
	alertView.defaultButtonShadowColor = [UIColor tinColor];
	alertView.defaultButtonFont = [UIFont boldFlatFontOfSize:16.0];
	alertView.defaultButtonTitleColor = [UIColor skyBlueColor];
}
