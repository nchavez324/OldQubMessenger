...
+ (UIColor *) emerlandColor {
    return [UIColor colorFromHexCode:@"00E440"];
}
...
+ (UIColor *) concreteColor {
    return [UIColor colorFromHexCode:@"E2E2E2"];
}
...
+ (UIColor *) skyBlueColor {
	return [UIColor colorFromHexCode:@"14B4FA"];
}

+ (UIColor *) softMetalColor {
	return [UIColor colorFromHexCode:@"F8F8F8"];
}

+ (UIColor *)tinColor {
	return [UIColor colorFromHexCode:@"BABABA"];
}

+ (UIColor *) marineBlueColor {
	return [UIColor colorFromHexCode:@"4FC9FF"];
}

+ (UIColor *) sunsetBlueColor {
	return [UIColor colorFromHexCode:@"0072A4"];
}

+ (UIColor *) color:(UIColor *)c withAlpha:(CGFloat)alpha{
	CGFloat r, g, b, a;
